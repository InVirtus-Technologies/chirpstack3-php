...
class ChannelConfiguration extends \Google\Protobuf\Internal\Message
{
     ...
     *     @type int $modulation
     *           Channel modulation.
     *     @type \Gw\LoRaModulationConfig $lora_modulation_config
     *           LoRa modulation config.
     *     @type \Gw\FSKModulationConfig $fsk_modulation_config
     ...
     * LoRa modulation config.
     *
     * Generated from protobuf field <code>.gw.LoRaModulationConfig lora_modulation_config = 3 [json_name = "loRaModulationConfig"];</code>
     * @return \Gw\LoRaModulationConfig|null
     */
     ...
     *
     * Generated from protobuf field <code>.gw.LoRaModulationConfig lora_modulation_config = 3 [json_name = "loRaModulationConfig"];</code>
     * @param \Gw\LoRaModulationConfig $var
     * @return $this
     */
    public function setLoraModulationConfig($var)
    {
        GPBUtil::checkMessage($var, \Gw\LoRaModulationConfig::class);
     ...
     * @return \Gw\FSKModulationConfig|null
     */
     ...
     *
     * Generated from protobuf field <code>.gw.FSKModulationConfig fsk_modulation_config = 4;</code>
     * @param \Gw\FSKModulationConfig $var
     * @return $this
     */
    public function setFskModulationConfig($var)
    {
        GPBUtil::checkMessage($var, \Gw\FSKModulationConfig::class);
