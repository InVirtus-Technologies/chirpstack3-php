...
class GlobalSearchResponse extends \Google\Protobuf\Internal\Message
{
     ...
     *
     *     @type array<\Api\GlobalSearchResult>|\Google\Protobuf\Internal\RepeatedField $result
     * }
     */
    ...
    /**
     * Generated from protobuf field <code>repeated .api.GlobalSearchResult result = 1;</code>
     * @param array<\Api\GlobalSearchResult>|\Google\Protobuf\Internal\RepeatedField $var
     * @return $this
     */
    public function setResult($var)
    {
        $arr = GPBUtil::checkRepeatedField($var, \Google\Protobuf\Internal\GPBType::MESSAGE, \Api\GlobalSearchResult::class);
        $this->result = $arr;
