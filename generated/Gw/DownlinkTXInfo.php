...
class DownlinkTXInfo extends \Google\Protobuf\Internal\Message
{
     ...
     *     @type int $timing
     *           Timing defines the downlink timing to use.
     *     @type \Gw\ImmediatelyTimingInfo $immediately_timing_info
     *           Immediately timing information.
     *     @type \Gw\DelayTimingInfo $delay_timing_info
     *           Context based delay timing information.
     *     @type \Gw\GPSEpochTimingInfo $gps_epoch_timing_info
     ...
     * LoRa modulation information.
     *
     * Generated from protobuf field <code>.gw.LoRaModulationInfo lora_modulation_info = 8 [json_name = "loRaModulationInfo"];</code>
    ...
    {
        GPBUtil::checkEnum($var, \Gw\DownlinkTiming::class);
        $this->timing = $var;
     ...
     * @return \Gw\ImmediatelyTimingInfo|null
     */
     ...
     *
     * Generated from protobuf field <code>.gw.ImmediatelyTimingInfo immediately_timing_info = 13;</code>
     * @param \Gw\ImmediatelyTimingInfo $var
     * @return $this
     */
    public function setImmediatelyTimingInfo($var)
    {
        GPBUtil::checkMessage($var, \Gw\ImmediatelyTimingInfo::class);
     ...
     * @return \Gw\DelayTimingInfo|null
     */
     ...
     *
     * Generated from protobuf field <code>.gw.DelayTimingInfo delay_timing_info = 14;</code>
     * @param \Gw\DelayTimingInfo $var
     * @return $this
     */
    public function setDelayTimingInfo($var)
    {
        GPBUtil::checkMessage($var, \Gw\DelayTimingInfo::class);
     ...
     * @return \Gw\GPSEpochTimingInfo|null
     */
     ...
     *
     * Generated from protobuf field <code>.gw.GPSEpochTimingInfo gps_epoch_timing_info = 15;</code>
     * @param \Gw\GPSEpochTimingInfo $var
     * @return $this
     */
    public function setGpsEpochTimingInfo($var)
    {
        GPBUtil::checkMessage($var, \Gw\GPSEpochTimingInfo::class);
